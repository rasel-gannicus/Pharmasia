...
const DesktopMenu = ({ cartQuantity, wishlist }: any) => {
    return (
        ...
        {wishlist?.length > 0 && (
          <Link
            href="/user/wishlist"
            className=" transition-colors hover:text-foreground hover:bg-slate-200 text-white hover:text-black bg-[#089BC6] py-2 px-3 relative  rounded flex gap-1 justify-between items-center"
          >
